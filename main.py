...
window = tk.Tk()
window.title("Fetal Health Classification")

window.geometry('1100x650')
window.configure(background='snow')

message = tk.Label(window, text="Check Fetal Health ", bg="snow", fg="black", width=48,
...
# Load the model
model = tensorflow.keras.models.load_model('fetal.h5')
